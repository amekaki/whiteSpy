...
<template>
    <div class="layout--main" :class="[navbarClasses, footerClasses, {'app-page': isAppPage}]">
        ...
        <vx-sidebar :currentPath="currentPath" :sidebarItems="sidebarItems" :logo="require('@/assets/images/logo/logo.png')" title="WhiteSpy" parent=".layout--main" />

        <div id="content-area" :class="[contentAreaClass, {'show-overlay': bodyOverlay}]">

            <div id="content-overlay"></div>

            <div class="content-wrapper" :style="{backgroundImage:'url('+backgroundImg+')'}">
...
export default {
    data() {
        return {
          currentPath:'/analyze/knowledgeGraph',
