...
<template>
    <vx-card title="Color" code-toggler>
        ...
        <div class="demo-alignment">
          ...
          <div><p>xxxqianban
            <span style="background-color: rgba(var(--vs-primary),.5);border-radius: 5%;padding-left: 3px;padding-right:3px " >xxxx
               <vs-icon icon="pageview" size="15px" color="primary" ></vs-icon></span>
            xxxxhouban</p>
