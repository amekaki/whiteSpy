    ...
    <div id="faq-page">
        ...
        <div class="faq-jumbotron">
            <div class="faq-jumbotron-content lg:p-32 md:p-24 sm:p-16 p-8 rounded-lg mb-base">
                <h1 class="mb-1 text-white">黑产群组检索</h1>
                <p class="text-white">检索结果为Telegram群组索引计划内容</p>
                <vs-input placeholder="检索黑产群组" v-model="faqSearchQuery" icon-pack="feather" icon="icon-search" size="large" class="w-full mt-6" icon-no-border />
            </div>
        </div>
        <div class="vx-row">
