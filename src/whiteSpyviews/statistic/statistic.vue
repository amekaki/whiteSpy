...
<!--          <p class="xl:w-3/4 lg:w-4/5 md:w-2/3 w-4/5 mx-auto text-white">You have done <strong>57.6%</strong> more sales-->
...
<!--                              :chartData="analyticsData.subscribersGained" type='area'></statistics-card-line>-->
<!--      </div>-->

<!--      &lt;!&ndash; CARD 3: ORDER RECIEVED &ndash;&gt;-->
<!--      <div class="vx-col w-full sm:w-1/2 md:w-1/2 lg:w-1/4 xl:w-1/4 mb-base">-->
...
<!--      </div>-->
      ...
      <div class="vx-col w-full md:w-full lg:w-full xl:w-full mb-base">

        <vx-card title="Support Tracker">
          <!-- CARD ACTION -->

          <template slot="actions">
            <change-time-duration-dropdown/>xx
          </template>
          ...
          <div slot="no-body">
            <div class="vx-row text-center">
              ...
              <div class="vx-col sm:w-3/5 justify-center mx-auto">
                <chinaMap></chinaMap>
...
<!--                                 :series="analyticsData.supportTrackerRadialBar.series"/>-->
              ...
              <div class="vx-col sm:w-1/5 justify-center mx-auto">
<!--                <listDataV></listDataV>-->
                <dv-border-box-13>
                   <div class="vx-row">
            <div class="vx-col w-1/2 mb-3">
...
import chinaMap from '@/whiteSpyviews/statistic/map.vue'
  import listDataV from '@/whiteSpyviews/statistic/list.vue'
  export default {
    data() {
      return {
