...
<template>
    <div class="h-screen flex w-full bg-img vx-row no-gutter items-center justify-center" id="page-login">
        <div class="vx-col sm:w-1/3 md:w-1/3 lg:w-1/3 xl:w-1/3 sm:m-0 m-4">
            <vx-card>
...
export default {
    ...
    computed: {
        validateForm() {
            return !this.errors.any() && this.phonenumber != '' && this.password != '';
        },
    },
    methods: {
        login() {
          this.$vs.loading()
            ...
            this.$store.dispatch('auth/loginAttempt', payload)
              .then(() => {
                ...
                this.$router.push('/statistic/allData')
                this.$vs.notify({
                    title: 'success',
                    text: "成功登陆",
                    iconPack: 'feather',
