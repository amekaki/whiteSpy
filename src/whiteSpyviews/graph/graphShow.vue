      ...
      <el-row :gutter="20">
        ...
        <vs-input icon="icon-search" icon-pack="feather" class="w-full mx-5 input-rounded-full no-icon-border"
          ...
          <div class="knowledgeGraph" style="display:flex ; flex-direction:row">
            ...
            <svg id='knowledgeGraphSvg' width="1000" height="650"></svg>
          </div>
        </el-col>
<!--        <el-col :span="8">-->
...
<script>
  ...
  import {getAllGraphData, getGraphDataByNodeId, getGraphDataByUserId} from "../../api/show";
    ...
    methods: {
      ...
      draw() {
        ...
        simulation.force('charge')
          .strength(-150) // 排斥力强度，正值相互吸引，负值相互排斥
        //存储关系图的数据
        let graph;
