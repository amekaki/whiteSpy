...
const router = new Router({
    ...
    // =============================================================================
        ...
        // =============================================================================
              ...
              {
                    path: '/analyze/knowledgeGraph',
                    name: 'knowledgeGraph',
                    component: () => import('./whiteSpyviews/graph/graphShow'),
                    meta: {
                        rule: 'editor'
                    }
                },
              {
                    path: '/list/groupList',
                    name: 'knowledgeGraph',
                    component: () => import('./whiteSpyviews/list/groupList'),
                    meta: {
                        rule: 'editor'
                    }
                },
               {
                    path: '/group/GroupMonitor',
                    name: 'groupMonitor',
                    component: () => import('./whiteSpyviews/GroupMonitor/groupMonitor'),
                    meta: {
                        rule: 'editor'
                    }
                },
              {
                    path: '/group/GroupMonitorIndex',
                    name: 'groupMonitor',
                    component: () => import('./whiteSpyviews/GroupMonitor/groupList'),
                    meta: {
                        rule: 'editor'
                    }
                },
              {
                    path: '/list/userList',
                    name: 'userList',
                    component: () => import('./whiteSpyviews/list/userList'),
                    meta: {
                        rule: 'editor'
                    }
                },
              {
                    path: '/statistic/map',
                    name: 'map',
                    component: () => import('./whiteSpyviews/statistic/map.vue'),
                    meta: {
                        rule: 'editor'
                    }
                },
              {
                    path: '/statistic/allData',
                    name: 'map',
                    component: () => import('./whiteSpyviews/statistic/all.vue'),
                    meta: {
                        rule: 'editor'
                    }
                },
              {
                    path: '/statistic/all',
                    name: 'map',
                    component: () => import('./whiteSpyviews/statistic/statistic'),
                    meta: {
                        rule: 'editor'
                    }
                },

              {
                    ...
                    name: 'GroupIndex',
                    component: () => import('./whiteSpyviews/groupIndex/GroupIndex.vue'),
                    meta: {
                        rule: 'editor'
                    }
                },
               {
                    path: '/loadTest',
                    name: '111',
                    component: () => import('./whiteSpyviews/loadTest'),
                    meta: {
                        rule: 'editor'
                    }
              },
              {
                    path: '/group/userView',
                    name: 'userView',
                    component: () => import('./whiteSpyviews/groupManage/user/userView'),
                    meta: {
                        rule: 'editor'
                    }
              },
              {
                    path: '/group/userViewIndex',
                    name: 'userViewIndex',
                    component: () => import('./whiteSpyviews/groupManage/user/userList'),
                    meta: {
                        rule: 'editor'
                    }
              },
              {
                    ...
                    name: 'userSetting',
                    component: () => import('./whiteSpyviews/setting/userSetting'),
                    meta: {
                        rule: 'editor'
                    }
              },
              {
                    path: '/group/analyse',
                    name: 'userSetting',
                    component: () => import('./whiteSpyviews/groupAnalyse/groupAnalyse'),
                    meta: {
                        rule: 'editor'
                    }
              },
              {
                    path: '/setting/botSetting',
                    name: 'botSetting',
                    component: () => import('./whiteSpyviews/setting/botSetting'),
                    meta: {
                        rule: 'editor'
                    }
              },
              {
                    path: '/group/chat',
                    name: 'GroupIndex',
                    component: () => import('./whiteSpyviews/chat/ChatLog'),
                    meta: {
                        rule: 'editor'
                    }
                },
              ...
              {
                    path: '/chattask/currentChatTask',
                    name: 'GroupIndex',
                    component: () => import('./whiteSpyviews/chatTask/currentTask'),
                    meta: {
                        rule: 'editor'
                    }
                },
        ...
        //         },
              {
...

                {
                    path: '/pages/login',
                    name: 'pageLogin',
                    component: () => import('./whiteSpyviews/auth/login.vue'),
                    meta: {
                        rule: 'editor'
                    }
                },
                {
                    path: '/pages/register',
                    name: 'pageRegister',
                    component: () => import('@/whiteSpyviews/auth/register.vue'),
                    meta: {
                        rule: 'editor'
                    }
                },
